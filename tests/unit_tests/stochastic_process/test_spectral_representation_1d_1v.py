...
def test_1d_1v_phi_random_input():
    """Test when all phi are random as defined by input"""
...
def test_1d_1v_phi_random_seed():
    """Test when all phase angles are random as defined by random_state"""
    srm_object = SpectralRepresentation(power_spectrum,
                                        time_interval, frequency_interval,
                                        n_times, n_frequencies,
                                        n_samples=n_samples,
